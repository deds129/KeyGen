...
-- Started on 2022-04-20 00:16:41
...
--
-- TOC entry 3013 (class 1262 OID 16394)
...
--
-- TOC entry 2996 (class 0 OID 24588)
-- Dependencies: 206
-- Data for Name: customers; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.customers (id, cust_name, cust_email, cust_phone, "сust_website", company_name) VALUES (1, 'kgeu_user', 'kgeu@kgeu.ru', '(843)519-42-20', 'https://kgeu.ru/', 'kgeu');


--
-- TOC entry 3007 (class 0 OID 24759)
-- Dependencies: 217
...
--
-- TOC entry 3006 (class 0 OID 24749)
-- Dependencies: 216
...
--
-- TOC entry 3004 (class 0 OID 24731)
-- Dependencies: 214
...
--
-- TOC entry 3002 (class 0 OID 24695)
-- Dependencies: 212
...
--
-- TOC entry 2991 (class 0 OID 16397)
-- Dependencies: 201
-- Data for Name: license_keys; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.license_keys (id, customer, host, port, lic_key, usr_id, lic_comment, start_date, end_date, license_type) VALUES (53, 1, '192.127.1.1.', 1111, 'Y29tLm5jaHVkaW5vdi5rZXlnZW4ubW9kZWwuTGljZW5zZUtleUA2NWJlMTIyNQ==com.nchudinov.keygen.model.LicenseKey@65be1225', 1, '', NULL, NULL, 1);
INSERT INTO public.license_keys (id, customer, host, port, lic_key, usr_id, lic_comment, start_date, end_date, license_type) VALUES (56, 1, '233.14.15.01', 8084, 'Y29tLm5jaHVkaW5vdi5rZXlnZW4ubW9kZWwuTGljZW5zZUtleUA3YTNmMzYzMg==com.nchudinov.keygen.model.LicenseKey@7a3f3632', 1, 'hello', NULL, NULL, 1);


--
-- TOC entry 2998 (class 0 OID 24623)
-- Dependencies: 208
...
--
-- TOC entry 3003 (class 0 OID 24716)
-- Dependencies: 213
...
INSERT INTO public.os_to_key (os_id, key_id) VALUES (2, 53);
INSERT INTO public.os_to_key (os_id, key_id) VALUES (1, 56);


--
-- TOC entry 3000 (class 0 OID 24647)
-- Dependencies: 210
...
--
-- TOC entry 2993 (class 0 OID 16405)
-- Dependencies: 203
...
--
-- TOC entry 2994 (class 0 OID 16408)
-- Dependencies: 204
-- Data for Name: usr; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.usr (id, active, password, username, usr_email, usr_phone_number, usr_name, activation_code, email, phone_number) VALUES (1, true, 'user', 'user', NULL, NULL, NULL, NULL, '', '');
INSERT INTO public.usr (id, active, password, username, usr_email, usr_phone_number, usr_name, activation_code, email, phone_number) VALUES (23, true, 'admin', 'admin', NULL, NULL, NULL, NULL, 'user', '');
...
SELECT pg_catalog.setval('public.license_types_id_seq', 17, true);
...
--
-- TOC entry 2858 (class 2606 OID 24764)
...
--
-- TOC entry 2859 (class 2606 OID 24769)
...
--
-- TOC entry 2856 (class 2606 OID 24736)
...
--
-- TOC entry 2857 (class 2606 OID 24741)
...
--
-- TOC entry 2852 (class 2606 OID 24796)
-- Name: license_keys license_keys_license_types_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.license_keys
    ADD CONSTRAINT license_keys_license_types_id_fk FOREIGN KEY (license_type) REFERENCES public.license_types(id);


--
-- TOC entry 2854 (class 2606 OID 24721)
...
--
-- TOC entry 2855 (class 2606 OID 24726)
...
-- Completed on 2022-04-20 00:16:41
